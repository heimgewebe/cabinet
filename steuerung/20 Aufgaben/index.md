...
| CAB-QA-004 | Externe Manifestreferenzen beobachten | Cabinet -> RepoBrief/Lenskit | Der Maintenance Report meldet keine Spezifikationsluecke mehr, aber zwei unobserved Manifestquellen. | Beobachtungslauf 2026-07-06 dokumentiert fehlende contract-konforme Cabinet-Manifeste; Registry bleibt unveraendert. | Mittel: Freshness kann mit Wahrheit verwechselt werden. | Kein aktuelles Manifest belegbar oder Pfad passt nicht zum Contract. | Leerstelle dokumentiert in `pruefung/30 Befunde/cab-qa-004-external-manifest-observation-2026-07-06.md`; naechster Schritt liegt bei RepoBrief/Lenskit. |
...
- [CAB-QA-004 Befund — externe Manifestreferenzen 2026-07-06](../../pruefung/30 Befunde/cab-qa-004-external-manifest-observation-2026-07-06.md)
